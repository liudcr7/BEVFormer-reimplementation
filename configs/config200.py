...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        assigner=dict(
            type='CusHungarianAssigner3D',
            cls_cost=dict(type='FocalLossCost', weight=2.0, alpha=0.25, gamma=2.0),
            reg_cost=dict(type='CusBBox3DL1Cost', weight=0.25))),
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'bevformer2/nuscenes_infos_temporal_train.pkl',
    ...
    val=dict(
        type=dataset_type,
             data_root=data_root,
             ann_file=data_root + 'bevformer2/nuscenes_infos_temporal_val.pkl',
